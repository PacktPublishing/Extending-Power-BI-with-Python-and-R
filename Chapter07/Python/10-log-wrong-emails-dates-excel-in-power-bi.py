...
dataset[filter_wrong_emails][['UserId', 'Email']].to_excel(r'D:\<your-path>\Chapter07\Python\wrong-data.xlsx', sheet_name='Wrong emails', index = False)
...
with pd.ExcelWriter(r'D:\<your-path>\Chapter07\Python\wrong-data.xlsx', mode='a') as writer: 
     dataset[filter_wrong_dates][['UserId', 'BannedDate']].to_excel(writer, sheet_name='Wrong dates', index = False)
